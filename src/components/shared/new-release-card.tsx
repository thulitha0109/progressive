    ...
    >
      ...
      <div className="relative w-28 sm:w-40 h-full shrink-0 overflow-hidden rounded-l-md rounded-r-none shadow-lg isolate ring-1 ring-white/10 ring-inset">
        ...
        {!isUpcoming && (
          <div
            className={cn(
              "absolute inset-0 flex items-center justify-center z-20 transition-all duration-300 pointer-events-auto",
        ...
        {isUpcoming && (
          <div
            className={cn(
              "absolute inset-0 flex flex-col gap-1 items-center justify-center bg-black/60 z-20 transition-all duration-300 backdrop-blur-[2px]"
            )}
          >
            ...
            {track.type && (
              <div
                className={cn(
                  ...
                  !["Warm", "Drive", "Peak"].includes(track.type) &&
